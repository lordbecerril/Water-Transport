...
def main():
    ...
    elementout = create_dataframe('run_1/element.out',3)
    elementout = append_dataframe(elementout, 'run_1/element1.out')
    elementout = append_dataframe(elementout, 'run_1/element2.out')
    elementout = append_dataframe(elementout, 'run_1/element3.out')
    elementout = append_dataframe(elementout, 'run_1/element4.out')
    elementout = append_dataframe(elementout, 'run_1/element5.out')
    elementout = append_dataframe(elementout, 'run_1/element6.out')
    elementout = append_dataframe(elementout, 'run_1/element7.out')
    elementout = append_dataframe(elementout, 'run_1/element8.out')
    elementout = append_dataframe(elementout, 'run_1/element9.out')
    elementout = append_dataframe(elementout, 'run_1/element10.out')

...
def main():
    ...
    elementout = create_dataframe('run_15/element.out',3)
    elementout = append_dataframe(elementout, 'run_15/element1.out')
    elementout = append_dataframe(elementout, 'run_15/element2.out')
    elementout = append_dataframe(elementout, 'run_15/element3.out')
    elementout = append_dataframe(elementout, 'run_15/element4.out')
    elementout = append_dataframe(elementout, 'run_15/element5.out')
    elementout = append_dataframe(elementout, 'run_15/element6.out')
    elementout = append_dataframe(elementout, 'run_15/element7.out')
    elementout = append_dataframe(elementout, 'run_15/element8.out')
    elementout = append_dataframe(elementout, 'run_15/element9.out')
    elementout = append_dataframe(elementout, 'run_15/element10.out')

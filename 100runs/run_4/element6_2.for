...
c**********************************************************
c
c  CREATE  A  SUMMARY OF MASSES  AND  ELEMENTS at SPECIFIED TIME
c
          if(time-t0.gt.1.0d6*365.0.and.tprevious-t0.le.1.0d6*365.0)then
C     
             open (11, file='element1.out', status='unknown')
C     rewind 11
c
      if (timestyle.eq.0.or.timestyle.eq.2) then
c        write (11,'(/,a,f18.5,/)') ' Time (days): ',t1
      else if (timestyle.eq.1) then
        write (11,'(/,a,i10,1x,i2,1x,f8.5,/)') ' Date: ',year,month,t1
      else if (timestyle.eq.3) then
c        write (11,'(/,a,f18.7,/)') ' Time (years): ',t1
      end if
c      write (11,'(2a,/)') '              a        e       i      mass',
c     %  '    Rot/day  Obl'
c
...
c Write values of a, e, i and m for surviving objects in an output file
      do j = 1, nbod
        k = code(iback(j))
        write (11,213) id(k),el(1,k),el(2,k),el(3,k),el(18,k),el(20,k),
     %      el(19,k)
      end do
      end if

          if(time-t0.gt.2.0d6*365.0.and.tprevious-t0.le.2.0d6*365.0)then
c
             open (11, file='element2.out', status='unknown')
c
      if (timestyle.eq.0.or.timestyle.eq.2) then
c        write (11,'(/,a,f18.5,/)') ' Time (days): ',t1
      else if (timestyle.eq.1) then
...
c Write values of a, e, i and m for surviving objects in an output file
     ...
     %      el(19,k)
          ...
          if(time-t0.gt.3.0d6*365.0.and.tprevious-t0.le.3.0d6*365.0)then
c
            open (11, file='element3.out', status='unknown')
c
      if (timestyle.eq.0.or.timestyle.eq.2) then
c        write (11,'(/,a,f18.5,/)') ' Time (days): ',t1
      else if (timestyle.eq.1) then
...
c Write values of a, e, i and m for surviving objects in an output file
     ...
     %      el(19,k)
          ...
          if(time-t0.gt.4.0d6*365.0.and.tprevious-t0.le.4.0d6*365.0)then
c
            open (11, file='element4.out', status='unknown')
c
      if (timestyle.eq.0.or.timestyle.eq.2) then
c        write (11,'(/,a,f18.5,/)') ' Time (days): ',t1
      else if (timestyle.eq.1) then
...
c Write values of a, e, i and m for surviving objects in an output file
     ...
     %      el(19,k)
          ...
          if(time-t0.gt.5.0d6*365.0.and.tprevious-t0.le.5.0d6*365.0)then
c
            open (11, file='element5.out', status='unknown')
c
      if (timestyle.eq.0.or.timestyle.eq.2) then
c        write (11,'(/,a,f18.5,/)') ' Time (days): ',t1
      else if (timestyle.eq.1) then
...
c Write values of a, e, i and m for surviving objects in an output file
     ...
     %      el(19,k)
          ...
          if(time-t0.gt.6.0d6*365.0.and.tprevious-t0.le.6.0d6*365.0)then
c
            open (11, file='element6.out', status='unknown')
c
      if (timestyle.eq.0.or.timestyle.eq.2) then
c        write (11,'(/,a,f18.5,/)') ' Time (days): ',t1
      else if (timestyle.eq.1) then
...
c Write values of a, e, i and m for surviving objects in an output file
     ...
     %      el(19,k)
          ...
          if(time-t0.gt.7.0d6*365.0.and.tprevious-t0.le.7.0d6*365.0)then
c
            open (11, file='element7.out', status='unknown')
c
      if (timestyle.eq.0.or.timestyle.eq.2) then
c        write (11,'(/,a,f18.5,/)') ' Time (days): ',t1
      else if (timestyle.eq.1) then
...
c Write values of a, e, i and m for surviving objects in an output file
     ...
     %      el(19,k)
          ...
          if(time-t0.gt.8.0d6*365.0.and.tprevious-t0.le.8.0d6*365.0)then
c
            open (11, file='element8.out', status='unknown')
c
      if (timestyle.eq.0.or.timestyle.eq.2) then
c        write (11,'(/,a,f18.5,/)') ' Time (days): ',t1
      else if (timestyle.eq.1) then
...
c Write values of a, e, i and m for surviving objects in an output file
     ...
     %      el(19,k)
          ...
          if(time-t0.gt.9.0d6*365.0.and.tprevious-t0.le.9.0d6*365.0)then
c
            open (11, file='element9.out', status='unknown')
c
      if (timestyle.eq.0.or.timestyle.eq.2) then
c        write (11,'(/,a,f18.5,/)') ' Time (days): ',t1
      else if (timestyle.eq.1) then
...
c Write values of a, e, i and m for surviving objects in an output file
     ...
     %      el(19,k)
          ...
          if(time-t0.gt.1.0d7*365.0.and.tprevious-t0.le.1.0d7*365.0)then
c
            open (11, file='element10.out', status='unknown')
c
      if (timestyle.eq.0.or.timestyle.eq.2) then
c        write (11,'(/,a,f18.5,/)') ' Time (days): ',t1
      else if (timestyle.eq.1) then

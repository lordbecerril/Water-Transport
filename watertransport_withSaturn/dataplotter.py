...
def main():
    ...
    run1_df = create_dataframe("./run_1/EARTHMOO.aei")
    run2_df = create_dataframe("./run_6/EARTHMOO.aei")
    run3_df = create_dataframe("./run_2/EARTHMOO.aei")
    ...
    run2_df = create_dataframe("./run_3/EARTHMOO.aei")
    run3_df = create_dataframe("./run_8/EARTHMOO.aei")
    run4_df = create_dataframe("./run_4/EARTHMOO.aei")
